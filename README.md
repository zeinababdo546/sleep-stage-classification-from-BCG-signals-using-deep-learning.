...
•	Bidirectional LSTM: Processes the feature sequence both forward and backward in time to capture long-term temporal dependencies across macro sleep structures.
